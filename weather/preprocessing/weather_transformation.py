...
# Constant for missing values - using NaN to indicate missing data
# NaN is the standard way to represent missing values in pandas/dask
...
def transform_long_to_wide(df_long: dd.DataFrame, 
    ...
    Args:
        df_long: Dask DataFrame in long format with columns:
                ...
                - ELEMENT: Measurement type (TOBS, TMAX, TMIN, PRCP, SNOW, SNWD, TAVG)
    ...
    Note:
        Missing values are filled with NaN to provide a standard indicator of missing data.
    """
    ...
    # Fill missing values with NaN to indicate missing data
